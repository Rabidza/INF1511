...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.AddButton.setGeometry(QtCore.QRect(40, 60, 75, 23))
        self.AddButton.setObjectName(_fromUtf8("AddButton"))
        self.EditButton = QtGui.QPushButton(Dialog)
        self.EditButton.setGeometry(QtCore.QRect(40, 100, 75, 23))
        self.EditButton.setObjectName(_fromUtf8("EditButton"))
        self.DeleteButton = QtGui.QPushButton(Dialog)
        self.DeleteButton.setGeometry(QtCore.QRect(40, 140, 75, 23))
        self.DeleteButton.setObjectName(_fromUtf8("DeleteButton"))
        self.DeleteAllButton = QtGui.QPushButton(Dialog)
        self.DeleteAllButton.setGeometry(QtCore.QRect(40, 180, 75, 23))
        self.DeleteAllButton.setObjectName(_fromUtf8("DeleteAllButton"))
        self.listWidget = QtGui.QListWidget(Dialog)
        self.listWidget.setGeometry(QtCore.QRect(230, 20, 256, 241))
